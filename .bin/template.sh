...
sudo apt-get install mplayer torchat qrencode python-qt4 python-qrcode qbittorrent pidgin pidgin-otr gimp inkscape ristretto geany chromium python3-pyqt5
